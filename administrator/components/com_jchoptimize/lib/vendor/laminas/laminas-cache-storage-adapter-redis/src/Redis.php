...
final class Redis extends AbstractAdapter implements ClearByNamespaceInterface, ClearByPrefixInterface, FlushableInterface, TotalSpaceCapableInterface
{
     ...
     *
     * @param null|array|RedisOptions|\Traversable $options
     */
     ...
     * @see    getOptions()
     *
     * @param array|RedisOptions|\Traversable $options
     *
     * @return Redis
     */
    ...
    protected function internalGetMetadata(&$normalizedKey)
    {
        ...
        try {
            ...
            if (\version_compare($redisVersion, '2.8', '>=')) {
                ...
                $metadata['ttl'] = -1 === $pttl ? null : $pttl / 1000;
                // redis >= 2.6, < 2.8
     ...
     *
     * @see https://github.com/zendframework/zend-cache/issues/88
     *
     * @param mixed $value
     *
     * @return mixed
