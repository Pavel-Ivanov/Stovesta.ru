...
$rating_ident = $vars->rating_ident;
$img_path = $vars->img_path;
$style = '#'. $rating_ident .'_rateBox span {
    background: url("'. $vars->img_path . 'jed-gray.png") no-repeat;
    width: 18px;
    height: 16px;
    display: inline-block;}
	#' . $vars->rating_ident . '_rateBox span.on {
		background: url("' . $vars->img_path . 'jed.png") no-repeat;
		display: inline-block;
	}';
...
?>
<!--<style>
	#<?/*= $vars->rating_ident; */?>_rateBox span {
		background: url('<?/*= $vars->img_path */?>jed-gray.png') no-repeat;
		width: 18px;
		height: 16px;
		display: inline-block;
...
-->
<div id="<?= $vars->rating_ident; ?>_rateBox"></div>
