...
abstract class AbstractUriElement
{
    ...
    /**
     * @var null|string The method to use for the element
     */
    protected $method;
     ...
     * @param null|string $currentUri The URI of the page where the link is embedded (or the base href)
     * @param null|string $method     The method to use for the link (GET by default)
     *
