...
class HtaccessMaker extends ServerConfigMaker
{
	...
	protected $allowedCallersForSave = [
		...
		'Akeeba\AdminTools\Admin\Controller\HtaccessMaker::includePhpHandlers',
	...
	/**
	 * Does the .htaccess file have lines which set the PHP handler?
	 *
	 * @return  bool
	 * @since   6.2.0
	 */
	...
	/**
	 * Get the .htaccess lines setting the PHP handler
	 *
	 * @return  string|null
	 * @since   6.2.0
	 */
	...
	/**
	 * Transcribe the PHP handlers from the .htaccess file into the custom rules.
	 *
	 * @return  void
	 * @throws  \Exception
	 * @since   6.2.0
	...
	public function includePhpHandlers()
	{
		...
		$contents = file_get_contents($htaccess_file);
		$handlers = $this->extractHandler($contents ?: '');
	...
	/**
	 * Extract the PHP handler lines from a .htaccess file
	 *
