...
$file_path = JPATH_ROOT . "/logs/b0_set_body_log.txt";
...
foreach($items as $item)
{
	...
	$fields[AccessoryIds::ID_BODY] = [];
	if (array_key_exists('144', $categories))	{
		$fields[AccessoryIds::ID_BODY][] = 'Lada Vesta sedan';
	}
	if (array_key_exists('145', $categories))	{
		$fields[AccessoryIds::ID_BODY][] = 'Lada Vesta SW';
	}
	if (array_key_exists('146', $categories))	{
		$fields[AccessoryIds::ID_BODY][] = 'Lada Vesta SW Cross';
	}
	if (array_key_exists('147', $categories))	{
		$fields[AccessoryIds::ID_BODY][] = 'Lada XRay';
	}
