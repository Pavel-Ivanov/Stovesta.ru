                ...
                <div class="uk-grid">
                    ...
                    <div class="uk-width-2-3">
                        ...
                        <p class="lrs-price-related">
                            ...
                            elseif ($item['isOriginal'] === 1) {
                                echo '<span class="uk-text-danger">Цена: ' . render_price($item['priceGeneral']) . '</span>';
                            }
                            else {
                                echo '<span class="uk-text-danger">Цена по золотой карте: ' . render_price($item['priceGold']) . '</span>';
                                echo '<p>Цена без карты: ' . render_price($item['priceGeneral']) . '</p>';
                            }
							?>
                        </p>
                    </div>
