						...
						<div>
							<small>
								...
								<?php if($this->section->params->get('events.subscribe_user')):?>
									<?php echo JText::_('CFOLLOWING') ?> <span class="badge lead"><?php echo CStatistics::follow($current_user->get('id'), $this->section->id) ?></span>
									<?php echo JText::_('CFOLLOWERS') ?>  <span class="badge lead"><?php echo CStatistics::followed($current_user->get('id'), $this->section->id) ?></span>
								<?php endif;?>
							</small>
						</div>
					<?php endif;?>
