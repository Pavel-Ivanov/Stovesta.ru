...
<?php if ($this->params->get('params.total_limit')):?>
	<div class="small">
        <?= JText::sprintf('F_OPTIONSLIMIT', $this->params->get('params.total_limit'));?>
    </div>
	<br>
<?php endif; ?>
<style>
#elements-list-<?= $this->id;?> .row-fluid
{
	display: table;
}
</style>
	...
	<p>
        <div id="variant_<?php echo $this->id;?>">
            <a id="show_variant_link_<?php echo $this->id;?>"
                ...
                href="javascript:void(0)" onclick="Cobalt.showAddForm(<?php echo $this->id;?>)">
                <i class="uk-icon-plus-square-o"></i>
                <?php echo JText::_($this->params->get('params.user_value_label', 'Your variant'));?></a>
        </div>
	</p>
<?php endif;?>
