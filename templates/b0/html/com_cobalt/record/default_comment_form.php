...
<div style="width: 600px; margin-left: 100px" class="modal hide fade" id="commentmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="form-horizontal">
	...
	<?php if($this->type->params->get('comments.comment_captcha') && !$this->user->get('id')):?>
		<div class="formelm uk-margin">
			<?php echo $this->comment_form->getInput('captcha'); ?>
		</div>
	<?php endif;?>

	<div class="uk-panel uk-panel-box-secondary-hover">
		<button type="button" class="uk-button uk-button-link" onclick="Joomla.submitbutton('comment.save')">
