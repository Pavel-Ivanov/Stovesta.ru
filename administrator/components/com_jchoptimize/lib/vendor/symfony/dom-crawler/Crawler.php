...
use _JchOptimizeVendor\Masterminds\HTML5;
use _JchOptimizeVendor\Symfony\Component\CssSelector\CssSelectorConverter;
...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    /**
     * @param null|\DOMNode|\DOMNode[]|\DOMNodeList|string $node A Node to use as the base for the crawling
     */
     ...
     *
     * @param null|\DOMNode|\DOMNode[]|\DOMNodeList|string $node A node
     *
     ...
     *
     * @param null|string $default             When not null: the value to return when the current node is empty
     ...
     *
     * @param null|\DOMNode|\DOMNode[]|\DOMNodeList|string $nodes
     *
     * @return static
     */
