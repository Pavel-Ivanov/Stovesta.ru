<?php
/**
 * Форма вывода списка комментариев
...
<?php if($this->type->params->get('comments.comments') == 'core'): ?>
	...
	<form method="post" name="adminForm" id="adminForm" class="uk-form" enctype="multipart/form-data">
		...
		<?php else :?>
			<?php if($this->tmpl_params['comment']->get('tmpl_core.comments_nocomment', 0)
                && in_array($this->item->params->get('comments.comments_access_post', $this->type->params->get('comments.comments_access_post')), $this->user->getAuthorisedViewLevels())):?>
