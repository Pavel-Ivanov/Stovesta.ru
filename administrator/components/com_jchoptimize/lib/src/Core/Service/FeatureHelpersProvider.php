...
class FeatureHelpersProvider implements ServiceProviderInterface
{
    public function register(Container $container)
    {
        $container->share(CdnDomains::class, function (Container $container): CdnDomains {
            return new CdnDomains($container, $container->get(Registry::class), $container->get(Cdn::class), $container->get(LinkBuilder::class));
        }, \true);
        $container->share(DynamicJs::class, function (Container $container): DynamicJs {
            return new DynamicJs($container, $container->get(Registry::class), $container->get(CacheManager::class), $container->get(LinkBuilder::class), $container->get(FilesManager::class));
        }, \true);
        ...
        $container->share(Fonts::class, function (Container $container): Fonts {
            return new Fonts($container, $container->get(Registry::class), $container->get(LinkBuilder::class));
        }, \true);
        ...
        $container->share(LazyLoadExtended::class, function (Container $container): LazyLoadExtended {
            return new LazyLoadExtended($container, $container->get(Registry::class), $container->get(LinkBuilder::class));
        }, \true);
        ...
        $sharedEvents->attach(LinkBuilder::class, 'preProcessHtml', new LazyListener([
