...
if(!JFactory::getApplication()->isClient('administrator')) {
	$document->addScript('/components/com_cobalt/library/js/main.js');
//	$document->addScript(JRoute::_('index.php?option=com_cobalt&task=ajax.mainJS&Itemid=1', false,1, true));
...
class MetaHelper
{
    ...
    public static function setMetaTag(array $metaSources)
    {
